...
if args.measure == "True" or args.measure == "true" or args.measure == "t":
    ...
    execute_bash_command(
            "docker exec --privileged kvs1 tc qdisc replace dev eth0 root netem delay {}us".format(delay))
...
now = datetime.now()
fig.write_html("test4_annaBellaDB_{}.html".format(now))
##############################################################################xxx

print("\nPLOT 'test4_annaBellaDB_{}.html' IS SAVED".format(now))
